                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Preventas Solicitadas <span>| Hoy</span></h5>
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="filter">
                                <a class="icon" href="#" data-bs-toggle="dropdown"><i class="ri bi-three-dots"></i></a>
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <i class="ri ri-shopping-bag-line"></i>
                                    <h6>Filtro</h6>
                                    </li>
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Preventas Convertidas <span>| Hoy</span></h5>
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Preventas Canceladas <span>| Hoy</span></h5>
                        ...
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>$<?php echo number_format(rand(5000, 10000), 2) ?></h6>
                                        <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>$<?php echo number_format(rand(1, 1000), 2) ?></h6>
                                        <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>
